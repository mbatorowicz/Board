export const copy = {
  ...
  admin: {
    ...
    announcementEditorPlaceholder: "Wpisz treść ogłoszenia…",
    announcementLinkPrompt: "Adres linku (https://)",
    announcementUploadFailed: "Nie udało się wgrać pliku.",
    announcementAttachmentsLimit: (max: number) =>
      `Możesz dodać maksymalnie ${max} załączników.`,
